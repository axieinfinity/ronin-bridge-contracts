...
export interface CommonGovernanceRelayInterface extends utils.Interface {
  functions: {
...
export interface CommonGovernanceRelay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CommonGovernanceRelayInterface;
