...
export interface MockBridgeRewardInterface extends utils.Interface {
  functions: {
    "calcReward(bool,uint256,uint256,uint256,uint256)": FunctionFragment;
    "calcRewardAndCheckSlashedStatus(bool,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
    ...
    "isValidBridgeTrackingResponse(uint256,uint256,uint256[])": FunctionFragment;
    "receiveRON()": FunctionFragment;
    "setContract(uint8,address)": FunctionFragment;
    "setRewardPerPeriod(uint256)": FunctionFragment;
    "shouldShareEqually(uint256,uint256,uint256[])": FunctionFragment;
    "shouldSlashedThisPeriod(uint256,uint256)": FunctionFragment;
    "syncReward(uint256)": FunctionFragment;
  };

  encodeFunctionData(
    functionFragment: "calcReward",
    values: [boolean, BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "calcRewardAndCheckSlashedStatus",
    values: [
      boolean,
      BigNumberish,
      BigNumberish,
  ...
  encodeFunctionData(
    functionFragment: "isValidBridgeTrackingResponse",
  ...
  encodeFunctionData(
    functionFragment: "shouldShareEqually",
    values: [BigNumberish, BigNumberish, BigNumberish[]]
  ): string;
  encodeFunctionData(
    functionFragment: "shouldSlashedThisPeriod",
...
export interface MockBridgeReward extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockBridgeRewardInterface;
  ...
  functions: {
    calcReward(
      isValidTrackingResponse: boolean,
      numBridgeOperators: BigNumberish,
    ...
    calcRewardAndCheckSlashedStatus(
      isValidTrackingResponse: boolean,
      numBridgeOperators: BigNumberish,
      rewardPerPeriod: BigNumberish,
      ballot: BigNumberish,
      totalBallot: BigNumberish,
      period: BigNumberish,
      slashUntilPeriod: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, boolean] & { reward: BigNumber; isSlashed: boolean }
    >;
    ...
    shouldSlashedThisPeriod(
      period: BigNumberish,
      slashUntilDuration: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
  ...
  calcRewardAndCheckSlashedStatus(
    ...
    slashUntilPeriod: BigNumberish,
    overrides?: CallOverrides
  ): Promise<[BigNumber, boolean] & { reward: BigNumber; isSlashed: boolean }>;
