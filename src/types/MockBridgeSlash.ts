...
export interface MockBridgeSlashInterface extends utils.Interface {
  functions: {
    ...
    "calcSlashUntilPeriod(uint8,uint256,uint256)": FunctionFragment;
    ...
    "isSlashDurationMetRemovalThreshold(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calcSlashUntilPeriod",
  ...
  encodeFunctionData(
    functionFragment: "isSlashDurationMetRemovalThreshold",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface MockBridgeSlash extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockBridgeSlashInterface;
  ...
  functions: {
    ...
    calcSlashUntilPeriod(
      tier: BigNumberish,
      period: BigNumberish,
      slashUntilPeriod: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { newSlashUntilPeriod: BigNumber }>;
    ...
    isSlashDurationMetRemovalThreshold(
      slashUntilPeriod: BigNumberish,
      period: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[boolean]>;
