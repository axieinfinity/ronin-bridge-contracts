...
export interface MockRoninValidatorSetOverridePrecompileInterface
...
export interface MockRoninValidatorSetOverridePrecompile extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockRoninValidatorSetOverridePrecompileInterface;
