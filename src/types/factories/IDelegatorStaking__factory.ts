...
import type {
  IDelegatorStaking,
  IDelegatorStakingInterface,
} from "../IDelegatorStaking";
...
export class IDelegatorStaking__factory {
  static readonly abi = _abi;
  static createInterface(): IDelegatorStakingInterface {
    return new utils.Interface(_abi) as IDelegatorStakingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDelegatorStaking {
    return new Contract(address, _abi, signerOrProvider) as IDelegatorStaking;
  }
}
