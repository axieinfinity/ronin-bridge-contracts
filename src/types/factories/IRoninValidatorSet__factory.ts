...
import type {
  IRoninValidatorSet,
  IRoninValidatorSetInterface,
} from "../IRoninValidatorSet";
...
export class IRoninValidatorSet__factory {
  static readonly abi = _abi;
  static createInterface(): IRoninValidatorSetInterface {
    return new utils.Interface(_abi) as IRoninValidatorSetInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IRoninValidatorSet {
    return new Contract(address, _abi, signerOrProvider) as IRoninValidatorSet;
  }
}
