...
import type {
  CoinbaseExecution,
  CoinbaseExecutionInterface,
} from "../CoinbaseExecution";
...
export class CoinbaseExecution__factory {
  static readonly abi = _abi;
  static createInterface(): CoinbaseExecutionInterface {
    return new utils.Interface(_abi) as CoinbaseExecutionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CoinbaseExecution {
    return new Contract(address, _abi, signerOrProvider) as CoinbaseExecution;
  }
}
