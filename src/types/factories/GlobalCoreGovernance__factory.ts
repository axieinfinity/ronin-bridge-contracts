...
import type {
  ...
  GlobalCoreGovernanceInterface,
} from "../GlobalCoreGovernance";
...
export class GlobalCoreGovernance__factory {
  static readonly abi = _abi;
  static createInterface(): GlobalCoreGovernanceInterface {
    return new utils.Interface(_abi) as GlobalCoreGovernanceInterface;
  }
  static connect(
    address: string,
