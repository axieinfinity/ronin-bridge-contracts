...
export class ProfileHandler__factory {
  static readonly abi = _abi;
  static createInterface(): ProfileHandlerInterface {
    return new utils.Interface(_abi) as ProfileHandlerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ProfileHandler {
    return new Contract(address, _abi, signerOrProvider) as ProfileHandler;
  }
}
