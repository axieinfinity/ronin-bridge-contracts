...
export class ProfileStorage__factory {
  static readonly abi = _abi;
  static createInterface(): ProfileStorageInterface {
    return new utils.Interface(_abi) as ProfileStorageInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ProfileStorage {
    return new Contract(address, _abi, signerOrProvider) as ProfileStorage;
  }
}
