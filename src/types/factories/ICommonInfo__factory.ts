...
import type { ICommonInfo, ICommonInfoInterface } from "../ICommonInfo";
...
export class ICommonInfo__factory {
  static readonly abi = _abi;
  static createInterface(): ICommonInfoInterface {
    return new utils.Interface(_abi) as ICommonInfoInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICommonInfo {
    return new Contract(address, _abi, signerOrProvider) as ICommonInfo;
  }
}
