...
export class CoreGovernance__factory {
  static readonly abi = _abi;
  static createInterface(): CoreGovernanceInterface {
    return new utils.Interface(_abi) as CoreGovernanceInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CoreGovernance {
    return new Contract(address, _abi, signerOrProvider) as CoreGovernance;
  }
}
