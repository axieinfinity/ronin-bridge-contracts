...
import type {
  CandidateStaking,
  CandidateStakingInterface,
} from "../CandidateStaking";
...
export class CandidateStaking__factory {
  static readonly abi = _abi;
  static createInterface(): CandidateStakingInterface {
    return new utils.Interface(_abi) as CandidateStakingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CandidateStaking {
    return new Contract(address, _abi, signerOrProvider) as CandidateStaking;
  }
}
