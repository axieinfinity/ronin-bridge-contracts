...
export class CandidateManager__factory {
  static readonly abi = _abi;
  static createInterface(): CandidateManagerInterface {
    return new utils.Interface(_abi) as CandidateManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CandidateManager {
    return new Contract(address, _abi, signerOrProvider) as CandidateManager;
  }
}
