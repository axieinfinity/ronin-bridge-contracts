...
import type { EmergencyExit, EmergencyExitInterface } from "../EmergencyExit";
...
export class EmergencyExit__factory {
  static readonly abi = _abi;
  static createInterface(): EmergencyExitInterface {
    return new utils.Interface(_abi) as EmergencyExitInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EmergencyExit {
    return new Contract(address, _abi, signerOrProvider) as EmergencyExit;
  }
}
