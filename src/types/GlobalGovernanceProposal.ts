...
export interface GlobalGovernanceProposalInterface extends utils.Interface {
  functions: {
...
export interface GlobalGovernanceProposal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GlobalGovernanceProposalInterface;
