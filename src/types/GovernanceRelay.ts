...
export interface GovernanceRelayInterface extends utils.Interface {
  functions: {
...
export interface GovernanceRelay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceRelayInterface;
