...
export interface IRoninValidatorSetInterface extends utils.Interface {
  functions: {
...
export interface IRoninValidatorSet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRoninValidatorSetInterface;
