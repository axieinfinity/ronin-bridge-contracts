...
export interface MockLogicValidatorSetV1Interface extends utils.Interface {
  functions: {
...
export interface MockLogicValidatorSetV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockLogicValidatorSetV1Interface;
