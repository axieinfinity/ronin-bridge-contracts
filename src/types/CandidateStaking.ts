...
export interface CandidateStakingInterface extends utils.Interface {
  functions: {
...
export interface CandidateStaking extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CandidateStakingInterface;
