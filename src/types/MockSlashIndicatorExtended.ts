...
export interface MockSlashIndicatorExtendedInterface extends utils.Interface {
  functions: {
    ...
    "slashFelony(address)": FunctionFragment;
    "slashMisdemeanor(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "slashFelony", values: [string]): string;
  encodeFunctionData(
    functionFragment: "slashMisdemeanor",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface MockSlashIndicatorExtended extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockSlashIndicatorExtendedInterface;
