...
export interface BridgeManagerCallbackRegisterInterface
...
export interface BridgeManagerCallbackRegister extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BridgeManagerCallbackRegisterInterface;
