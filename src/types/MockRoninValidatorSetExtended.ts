...
export interface MockRoninValidatorSetExtendedInterface
  extends utils.Interface {
  functions: {
    "DEFAULT_ADDITION_GAS()": FunctionFragment;
    "PERIOD_DURATION()": FunctionFragment;
    "addValidators(address[])": FunctionFragment;
    "arrangeValidatorCandidates(address[],uint256[],uint256,uint256)": FunctionFragment;
    ...
    "getJailUntils(address[])": FunctionFragment;
    ...
    "initEpoch()": FunctionFragment;
    "initialize(address,address,address,address,address,address,uint256,uint256,uint256,uint256,uint256,uint256[2])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "arrangeValidatorCandidates",
  ...
  encodeFunctionData(
    functionFragment: "getJailUntils",
    values: [string[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "initEpoch", values?: undefined): string;
  encodeFunctionData(
...
export interface MockRoninValidatorSetExtended extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockRoninValidatorSetExtendedInterface;
  ...
  functions: {
    ...
    arrangeValidatorCandidates(
      _candidates: string[],
      _trustedWeights: BigNumberish[],
      _newValidatorCount: BigNumberish,
    ...
    epochOf(
      _block: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { _epoch: BigNumber }>;
    ...
    getJailUntils(
      _addrs: string[],
      overrides?: CallOverrides
    ): Promise<[BigNumber[]] & { jailUntils_: BigNumber[] }>;
    ...
    initializeV3(
      fastFinalityTrackingContract: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    addValidators(_addrs: string[], overrides?: CallOverrides): Promise<void>;
    ...
    initEpoch(overrides?: CallOverrides): Promise<void>;
