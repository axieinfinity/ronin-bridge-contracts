...
export interface GlobalCoreGovernanceInterface extends utils.Interface {
  functions: {
...
export interface GlobalCoreGovernance extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GlobalCoreGovernanceInterface;
