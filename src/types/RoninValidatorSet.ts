...
export interface RoninValidatorSetInterface extends utils.Interface {
  functions: {
...
export interface RoninValidatorSet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoninValidatorSetInterface;
