...
export interface CandidateManagerInterface extends utils.Interface {
  functions: {
...
export interface CandidateManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CandidateManagerInterface;
