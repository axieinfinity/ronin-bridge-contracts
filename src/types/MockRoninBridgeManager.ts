...
export type GlobalProposalDetailStruct = {
  nonce: BigNumberish;
  expiryTimestamp: BigNumberish;
...
export type GlobalProposalDetailStructOutput = [
  BigNumber,
  BigNumber,
  number[],
  BigNumber[],
...
export interface MockRoninBridgeManagerInterface extends utils.Interface {
  functions: {
    "DOMAIN_SEPARATOR()": FunctionFragment;
    "addBridgeOperators(uint96[],address[],address[])": FunctionFragment;
    "castGlobalProposalBySignatures((uint256,uint256,uint8[],uint256[],bytes[],uint256[]),uint8[],(uint8,bytes32,bytes32)[])": FunctionFragment;
    ...
    "getGlobalProposalSignatures(uint256)": FunctionFragment;
    ...
    "globalProposalVoted(uint256,address)": FunctionFragment;
    ...
    "proposeGlobal(uint256,uint8[],uint256[],bytes[],uint256[])": FunctionFragment;
    "proposeGlobalProposalStructAndCastVotes((uint256,uint256,uint8[],uint256[],bytes[],uint256[]),uint8[],(uint8,bytes32,bytes32)[])": FunctionFragment;
    ...
    "resolveTargets(uint8[])": FunctionFragment;
    ...
    "updateManyTargetOption(uint8[],address[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "castGlobalProposalBySignatures",
    values: [GlobalProposalDetailStruct, BigNumberish[], SignatureStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getGlobalProposalSignatures",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "globalProposalVoted",
  ...
  encodeFunctionData(
    functionFragment: "proposeGlobal",
    values: [
      BigNumberish,
      BigNumberish[],
      BigNumberish[],
  ...
  encodeFunctionData(
    functionFragment: "proposeGlobalProposalStructAndCastVotes",
    values: [GlobalProposalDetailStruct, BigNumberish[], SignatureStruct[]]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "resolveTargets",
    values: [BigNumberish[]]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "updateManyTargetOption",
    values: [BigNumberish[], string[]]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "GlobalProposalCreated(uint256,bytes32,tuple,bytes32,tuple,address)": EventFragment;
    ...
    "TargetOptionUpdated(uint8,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GlobalProposalCreated"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TargetOptionUpdated"): EventFragment;
...
export type GlobalProposalCreatedEvent = TypedEvent<
  [
    BigNumber,
    string,
    ProposalDetailStructOutput,
    string,
    GlobalProposalDetailStructOutput,
    string
  ],
  {
    round: BigNumber;
    ...
    globalProposalHash: string;
    globalProposal: GlobalProposalDetailStructOutput;
    creator: string;
  }
>;

export type GlobalProposalCreatedEventFilter =
  TypedEventFilter<GlobalProposalCreatedEvent>;
...
export type TargetOptionUpdatedEvent = TypedEvent<
  [number, string],
  { targetOption: number; addr: string }
>;

export type TargetOptionUpdatedEventFilter =
  TypedEventFilter<TargetOptionUpdatedEvent>;
...
export interface MockRoninBridgeManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockRoninBridgeManagerInterface;
  ...
  functions: {
    ...
    castGlobalProposalBySignatures(
      globalProposal: GlobalProposalDetailStruct,
  ...
  filters: {
    ...
    "GlobalProposalCreated(uint256,bytes32,tuple,bytes32,tuple,address)"(
      round?: BigNumberish | null,
      proposalHash?: BytesLike | null,
      proposal?: null,
      globalProposalHash?: null,
      globalProposal?: null,
      creator?: null
    ): GlobalProposalCreatedEventFilter;
    GlobalProposalCreated(
      round?: BigNumberish | null,
      proposalHash?: BytesLike | null,
      proposal?: null,
      globalProposalHash?: null,
    ...
    "TargetOptionUpdated(uint8,address)"(
      targetOption?: BigNumberish | null,
      addr?: string | null
    ): TargetOptionUpdatedEventFilter;
    TargetOptionUpdated(
      targetOption?: BigNumberish | null,
      addr?: string | null
    ): TargetOptionUpdatedEventFilter;
