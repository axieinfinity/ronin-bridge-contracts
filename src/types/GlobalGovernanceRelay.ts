...
export interface GlobalGovernanceRelayInterface extends utils.Interface {
  functions: {
...
export interface GlobalGovernanceRelay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GlobalGovernanceRelayInterface;
