...
export interface MockLogicValidatorSetCoreInterface extends utils.Interface {
  functions: {
...
export interface MockLogicValidatorSetCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockLogicValidatorSetCoreInterface;
