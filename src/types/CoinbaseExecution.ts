...
export interface CoinbaseExecutionInterface extends utils.Interface {
  functions: {
...
export interface CoinbaseExecution extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CoinbaseExecutionInterface;
