...
export interface RoninBridgeManagerInterface extends utils.Interface {
  functions: {
...
export interface RoninBridgeManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoninBridgeManagerInterface;
