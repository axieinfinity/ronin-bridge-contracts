...
export interface MainchainBridgeManagerInterface extends utils.Interface {
  functions: {
    ...
    "globalProposalRelayed(uint256)": FunctionFragment;
    "isBridgeOperator(address)": FunctionFragment;
    "minimumVoteWeight()": FunctionFragment;
    "registerCallbacks(address[])": FunctionFragment;
    "relayGlobalProposal((uint256,uint256,uint8[],uint256[],bytes[],uint256[]),uint8[],(uint8,bytes32,bytes32)[])": FunctionFragment;
    "relayProposal((uint256,uint256,uint256,address[],uint256[],bytes[],uint256[]),uint8[],(uint8,bytes32,bytes32)[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "globalProposalRelayed",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "relayGlobalProposal",
    values: [GlobalProposalDetailStruct, BigNumberish[], SignatureStruct[]]
  ): string;
  encodeFunctionData(
    functionFragment: "relayProposal",
...
export interface MainchainBridgeManager extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MainchainBridgeManagerInterface;
