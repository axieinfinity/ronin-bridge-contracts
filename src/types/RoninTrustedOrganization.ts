...
export interface RoninTrustedOrganizationInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [TrustedOrganizationStruct[], BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface RoninTrustedOrganization extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RoninTrustedOrganizationInterface;
  ...
  functions: {
    ...
    getAllTrustedOrganizations(
      ...
      [TrustedOrganizationStructOutput[]] & {
        _list: TrustedOrganizationStructOutput[];
      }
    >;
    ...
    initialize(
      _trustedOrgs: TrustedOrganizationStruct[],
      __num: BigNumberish,
      __denom: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
